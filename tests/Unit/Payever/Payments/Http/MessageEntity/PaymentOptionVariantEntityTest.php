...
/**
 * Class PaymentOptionVariantEntityTest
 *
 * @see \Payever\Sdk\Payments\Http\MessageEntity\PaymentOptionVariantEntity
 */
class PaymentOptionVariantEntityTest extends AbstractMessageEntityTestCase
{
