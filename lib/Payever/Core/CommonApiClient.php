...
class CommonApiClient implements CommonApiClientInterface
{
     ...
     *
     * @link https://docs.payever.org/api/payments/v3/getting-started-v3/authentication Documentation
     *
